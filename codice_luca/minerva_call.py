...
MODEL_PATH = "minerva-7b-instruct"
...
for idx, row in df.iterrows():
    ...
    if i%5 == 0:
        ...
        out_df.to_csv(f"checkpoint/minerva_lower_answers_partial_{i}.csv", index=False)


out_df = pd.DataFrame(results)
out_df.to_csv("minerva_lower_answers.csv", index=False)
